...
Body: fill [`.github/pull_request_template.md`](../.github/pull_request_template.md) — Summary (prefer bullets, what/why), Related issue (`#N/A` unless an issue exists), two checkboxes (secrets + tests). No “generated by” footer.
...
Push `-u` if needed. Return the PR URL. Do not force-push `main`/`develop`.
