...
import { requiresPasswordForLifecycle, resolveVaultPasswordHint, type VaultListItem, type VaultLifecycleIntent } from "@upriv/shared";
...
import { SettingsField } from "@/features/vault-settings";
