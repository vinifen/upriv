...
pub use paths::{
    ...
    deactivate_vault_root_alias_everywhere, discover_bootstrap_root, discover_vault_root_near,
    ...
    save_app_settings_with_alias_sync, setup_nearby_anchor, sync_alias_with_app_settings,
    ...
    VaultRootMode, VaultRootSource, VAULT_ROOT_ALIAS_FILE, VAULT_ROOT_SETTINGS_REL,
};
