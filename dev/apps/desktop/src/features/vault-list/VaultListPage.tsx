...
import { VaultBackupsModal } from "@/features/vault-backups";
import { CreateVaultWizardModal } from "@/features/vault-create";
import { FileManagerLayer } from "@/features/file-manager";
import { HelpModal } from "@/features/help";
import { LogsModal } from "@/features/logs";
import { VaultLifecycleLayer } from "@/features/vault-lifecycle";
import { VaultSettingsModal } from "@/features/vault-settings";
...
export function VaultListPage() {
  ...
  const { header, list, lifecycle, toast, note, backups, settings, appSettings, logs, help, createVault } =
    screen;
